...
class PublicPlaceControllerTest {
    ...
    void findAll_shouldReturnMappedPagedResponse() {
        ...
        Place place = new Place(id, "Erevan", "A city", "Body",
                List.of(), List.of(PlaceCategory.CITY), null, EntityStatus.CANON, null, now, now, Language.EN, UUID.randomUUID(), false);
        when(findAllPlacesUseCase.findAll(any(), any()))
    ...
    void findById_shouldDelegateToUseCaseAndMapResult() {
        ...
        UUID id = UUID.randomUUID();
        Place place = new Place(id, "Erevan", "A city", "Body",
                List.of(), List.of(PlaceCategory.REGION), null, EntityStatus.CANON, null, now, now, Language.EN, UUID.randomUUID(), false);
