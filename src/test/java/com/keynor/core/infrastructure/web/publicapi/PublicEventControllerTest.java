...
class PublicEventControllerTest {
    ...
    void findAll_shouldReturnMappedPagedResponse() {
        ...
        Event event = new Event(id, "The First Sundering", "A cataclysmic event", "Body",
                List.of(), List.of(EventCategory.BATTLE), EntityStatus.CANON, null, now, now, Language.EN, UUID.randomUUID(), false);
        when(findAllEventsUseCase.findAll(any(), any()))
    ...
    void findById_shouldDelegateToUseCaseAndMapResult() {
        ...
        UUID id = UUID.randomUUID();
        Event event = new Event(id, "The First Sundering", "A cataclysmic event", "Body",
                List.of(), List.of(EventCategory.DIVINE), EntityStatus.CANON, null, now, now, Language.EN, UUID.randomUUID(), false);
