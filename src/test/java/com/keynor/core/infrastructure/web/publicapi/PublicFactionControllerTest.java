...
class PublicFactionControllerTest {
    ...
    void findAll_shouldReturnMappedPagedResponse() {
        ...
        Faction faction = new Faction(id, "The Iron Order", "A guild", "Body",
                List.of(), List.of(FactionCategory.ORDER), List.of(), EntityStatus.CANON, null, now, now, Language.EN, UUID.randomUUID());
        when(findAllFactionsUseCase.findAll(any(), any()))
    ...
    void findById_shouldDelegateToUseCaseAndMapResult() {
        ...
        UUID id = UUID.randomUUID();
        Faction faction = new Faction(id, "The Iron Order", "A guild", "Body",
                List.of(), List.of(FactionCategory.GUILD), List.of(), EntityStatus.CANON, null, now, now, Language.EN, UUID.randomUUID());
