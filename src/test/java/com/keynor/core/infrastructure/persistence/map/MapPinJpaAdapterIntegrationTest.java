...
class MapPinJpaAdapterIntegrationTest {
    ...
    void save_shouldPersistAndBeFoundByMapId() {
        ...
        MapPin pin = new MapPin(UUID.randomUUID(), MAP_ID, EntityType.CHARACTER, entityId, 0.25, 0.75, Instant.now());
    ...
    void deleteById_shouldRemovePin() {
        ...
        MapPin pin = mapPinRepository.save(
                new MapPin(UUID.randomUUID(), MAP_ID, EntityType.PLACE, entityId, 0.1, 0.9, Instant.now()));
